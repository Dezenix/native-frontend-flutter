...
class CloudySunset extends StatelessWidget {
  const CloudySunset({Key? key}) : super(key: key);
  @override
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [
                    Color.fromRGBO(60, 51, 94, 1),
                    Color.fromRGBO(23, 149, 167, 0.45),
                    Color.fromRGBO(255, 0, 184, 0)
                  ])),
              child: const MainTemperature(image: 'lib/assets/images/sunset-clouds.png', temperature: '28', desc: "Sunset, Clouds")
            ),
          BottomSection(),
          ],
        );
